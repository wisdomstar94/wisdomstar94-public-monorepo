...
import { ActionManager, ArcRotateCamera, DirectionalLight, GroundMesh, HavokPlugin, MeshBuilder, PhysicsBody, PhysicsMotionType, PhysicsShapeBox, ShadowGenerator } from "@babylonjs/core";
...
export default function Page() {
  ...
  const babylonCharacterController = useBabylonCharacterController({
    ...
    onLoaded(info) {
      ...
      info.characterMeshes.forEach(mesh => {
